...
class Currency {
  ...
  static final Map<String,String> curencyNames  ={
    ...
    "YER": "也门里亚尔",
    "ZAR": "南非兰特"};
 static final Map<String,String> cca2_currency = 
  {
    "ad": "EUR",
    "ae": "AED",
    "af": "AFN",
  ...
  static List<SimpleExchangeCard> LoadCurrency() {
    ...
    cca2_currency.forEach((key, value) {
      String currencyName = curencyNames[value] ?? "unknown_name";
      SimpleCards.add(SimpleExchangeCard(currencyName: currencyName, currencyCode: value, currencyConutry: key));
    });
    return SimpleCards;
  }
